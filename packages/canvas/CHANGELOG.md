...
- c664738: Annotations (and hosts) can now write back to the block they're anchored to (#90).
...
- 0f3f722: Pre-publish hardening for downstream consumers.
...
- Updated dependencies [0f3f722]
  - @hiermark/editor@0.4.0
